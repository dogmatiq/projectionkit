...
type MessageHandler interface {
	...
	HandleEvent(ctx context.Context, tx Tx, s dogma.ProjectionEventScope, m dogma.Message) error
	...
	Compact(ctx context.Context, db DB, s dogma.ProjectionCompactScope) error
}
