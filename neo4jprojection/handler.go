...
type MessageHandler interface {
	...
	HandleEvent(ctx context.Context, tx neo4j.ExplicitTransaction, s dogma.ProjectionEventScope, m dogma.Message) error
	...
	Compact(ctx context.Context, db neo4j.DriverWithContext, s dogma.ProjectionCompactScope) error
}
