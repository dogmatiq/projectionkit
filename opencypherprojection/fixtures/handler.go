...
type MessageHandler struct {
	...
	HandleEventFunc func(context.Context, neo4j.ExplicitTransaction, dogma.ProjectionEventScope, dogma.Message) error
	TimeoutHintFunc func(m dogma.Message) time.Duration
	CompactFunc     func(context.Context, neo4j.DriverWithContext, dogma.ProjectionCompactScope) error
}
...
// returns nil.
func (h *MessageHandler) Compact(ctx context.Context, db neo4j.DriverWithContext, s dogma.ProjectionCompactScope) error {
